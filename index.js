...
app.post('/answer/:id', (req, res, next) => {
	...
	if (teams[teamNumber].classes[req.body.coordY][req.body.coordX] == cellClasses[1]) {
	    teams[teamNumber].classes[req.body.coordY][req.body.coordX] = cellClasses[3]; //right-from-first-try
	    teams[teamNumber].table[req.body.coordY][req.body.coordX] = points[req.body.coordX];
	    //fs.writeFile("/result.html", );
	}
	if (teams[teamNumber].classes[req.body.coordY][req.body.coordX] == cellClasses[2]) {
	    teams[teamNumber].classes[req.body.coordY][req.body.coordX] = cellClasses[4];
	    teams[teamNumber].table[req.body.coordY][req.body.coordX] = points[req.body.coordX] / 2;
	}
	const newLog = "Команда " + teams[teamNumber].name + " решила задачу №" + req.body.coordX + " в теме " + teams[1].table[req.body.coordY][0] + ".";
	longpoll.publish("/poll", {
	    numberOfNewPenalties: 0,
	    numberOfNewCells: 1,
	    cell: [{ teamNumber: teamNumber, coordX: req.body.coordX, coordY: req.body.coordY, className: teams[teamNumber].classes[req.body.coordY][req.body.coordX], points: teams[teamNumber].table[req.body.coordY][req.body.coordX]}],
	    numberOfNewLogs: 1,
	    newLog: [newLog]});
    } else {
	if (teams[teamNumber].classes[req.body.coordY][req.body.coordX] == cellClasses[2]) {
	    teams[teamNumber].classes[req.body.coordY][req.body.coordX] = cellClasses[0]
	}
	if (teams[teamNumber].classes[req.body.coordY][req.body.coordX] == cellClasses[1]) {
	    teams[teamNumber].classes[req.body.coordY][req.body.coordX] = cellClasses[2]
	}
	const newLog = "Команда " + teams[teamNumber].name + " не решила задачу №" + req.body.coordX + " в теме " + teams[1].table[req.body.coordY][0] + ".";
	longpoll.publish("/poll", {
	    numberOfNewPenalties: 0,
	    numberOfNewCells: 1,
	    cell: [{ teamNumber: teamNumber, coordX: req.body.coordX, coordY: req.body.coordY, className: teams[teamNumber].classes[req.body.coordY][req.body.coordX], points: teams[teamNumber].table[req.body.coordY][req.body.coordX]}],
    ...
    console.log('coordX:', req.body.coordX);
